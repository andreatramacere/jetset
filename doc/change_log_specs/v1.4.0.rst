...
- A complete example is available in the MCMC section of :ref:`model_fitting_ssc_plus_radio_compmp`
...
- A complete fitting workflow (SSC + extended radio component, minuit and MCMC) is available in :ref:`model_fitting_ssc_plus_radio_compmp`
...
- To enable internal absorption for model fitting see the ``How to enable Internal absorption`` section of
  :ref:`model_fitting_ec`
