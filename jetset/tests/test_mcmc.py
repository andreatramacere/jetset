import pytest
from .test_model_fit import test_model_fit_lsb

def test_emcee(model_minimizer=None, plot=False):
    from jetset.mcmc import McmcSampler

    if model_minimizer is None:

        jet_bf_model, model_minimizer, fit_model_lsb_new=test_model_fit_lsb(plot=plot)
