...
double rate_compton_GR(struct blob *pt_GR) {
     ...
     * \author Andrea Tramacere
     * \date 27-04-2004
     * \brief helper functions for IC emission
     * 
     */
    double rate_comp=0;
...
//=========================================================================================
// IC Integration TRAPEZOIDAL seed photons/ SIMPSON  EQUI-LOG GRID electrons
// nu_Sync=>nu_seed
// I_nu_Sync=>I_nu_seed
...
double integrale_IC( struct blob * pt, double a, double b, int stat_frame) {
    ...
    // - 0.5/3.0 from  simpson int in  gamma
    // - 0.5 trapezoidal rule in nu
    //============================================================
...
//=========================================================================================
// Kernel for  Compton coolig, Moderski et al. 2005 MNRAS 363
// Eq. 3
